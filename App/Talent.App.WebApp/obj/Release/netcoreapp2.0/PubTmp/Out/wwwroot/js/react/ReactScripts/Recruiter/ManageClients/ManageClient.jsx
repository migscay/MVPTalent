...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'http://mvptalentp.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'http://mvptalenti.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
