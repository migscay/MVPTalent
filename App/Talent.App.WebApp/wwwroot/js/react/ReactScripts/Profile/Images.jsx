...
export class Images extends React.Component {
    ...
    loadImages(Id) {
        ...
        $.ajax({
            url: 'http://localhost:60298/profile/profile/getEmployerProfileImage/?id=' + Id,
            headers: {
            ...
            success: function (res) {
                ...
                if (res.employerProfile.length > 0) {
                    for (var i = 0; i < res.employerProfile.length; i++) {
                        imageSrcArr.push("http://localhost:60298/profile/profile/getEmployerProfileImages/?Id=" + res.employerProfile[i].fileName);
    ...
    fileUploadHandler(Id) {
        ...
        $.ajax({
            url: 'http://localhost:60298/profile/profile/addEmployerProfileImages',
            headers: {
                'Authorization': 'Bearer ' + cookies
            },
            type: "POST",
