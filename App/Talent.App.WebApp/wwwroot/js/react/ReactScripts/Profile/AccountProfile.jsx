...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'http://localhost:60298/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'http://localhost:60298/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='http://localhost:60298/profile/profile/updateProfilePhoto'
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'http://localhost:60298/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'http://localhost:60298/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                        <SelfIntroduction
